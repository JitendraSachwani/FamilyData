...
public class Main3Activity extends AppCompatActivity implements Validator.ValidationListener{
    ...
    private TextInputLayout first_name_layout, middle_name_layout, last_name_layout, fathers_name_layout, fathers_gaav_layout, mother_name_layout,
            mother_gaav_layout,  qualification_layout, work_layout,
            other_int_layout, mobile_no_layout, email_layout;

    private TextInputLayout dob_layout,father_layout, mother_layout, paternal_mama_layout, maternal_mama_layout, spouse_name_layout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.family_member_form);
        ...
        setTitle("Family #" + family_no + " Member Details:");
...

        {
            ...
            pickDate.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    DatePickerDialog dpd = new DatePickerDialog(Main3Activity.this,
            ...
            public void onResponse(Call call, Response response) throws IOException {
                if (!response.isSuccessful()) {
                    ...
                    try {
                        ...
                        {
                            Intent i = new Intent(Main3Activity.this, Add_members.class)
